...
public class LosePopupScreen extends Stage {
    ...
    public LosePopupScreen(GameLauncher game) {
        this.game = game;
        table = new Table();
        table.center();
        ...
        table.add(retryLevel).size(retryLevel.getWidth()+20, retryLevel.getHeight()+20).padTop(210).padRight(150).padLeft(60);
