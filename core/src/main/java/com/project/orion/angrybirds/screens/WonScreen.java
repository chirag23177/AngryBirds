...
public class WonScreen implements Screen {
    ...
    public WonScreen(GameLauncher game) {
        this.game = game;
    ...
    public void show() {
        ...
        Button nextLevel = new Button(new TextureRegionDrawable(next));
        ...
        table.add(nextLevel).size(nextLevel.getWidth()+50, nextLevel.getHeight()+50).padTop(500).padRight(60);
        table.add(retryLevel).size(retryLevel.getWidth()+50, retryLevel.getHeight()+50).padTop(500).padRight(60);
